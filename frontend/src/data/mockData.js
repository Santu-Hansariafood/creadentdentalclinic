...
export const medicalRecords = [
  {
    ...
    notes:
      "Root canal completed successfully. Crown placement recommended in 2 weeks. Patient tolerated procedure well.",
    attachments: [
  ...
  },
  {
    ...
    prescriptions: [],
    notes:
      "Regular check-up. No cavities detected. Good oral hygiene maintained. Recommended to continue current dental care routine.",
    attachments: [
  ...
  },
  {
    ...
    prescriptions: [],
    notes:
      "Small cavity filled with composite resin. No anesthesia required. Patient advised to avoid hard foods for 24 hours.",
    attachments: [
  ...
  },
  {
    ...
    notes:
      "Moderate to severe gum disease detected. Deep cleaning performed. Patient educated on proper oral hygiene. Follow-up in 6 weeks to assess healing.",
    attachments: [
...
export const prescriptions = [
  {
    ...
    notes:
      "Antibiotics to prevent infection. Pain medication for discomfort management.",
    status: "Active",
    refillsRemaining: 0,
  },
  {
    ...
    medications: [
      {
        ...
        duration: "2 weeks",
        instructions:
          "Rinse for 30 seconds after brushing. Do not swallow. Avoid eating or drinking for 30 minutes after use.",
        quantity: 1,
      },
      {
        name: "Doxycycline",
        ...
        duration: "7 days",
        instructions:
          "Take with full glass of water. Avoid lying down for 30 minutes after taking.",
        quantity: 7,
      },
    ],
    diagnosis: "Chronic Periodontitis",
    notes:
      "Antimicrobial therapy for gum disease treatment. Follow-up required.",
    status: "Completed",
    refillsRemaining: 0,
  },
  {
...
export const invoices = [
  ...
  },
  {
    ...
    notes:
      "Fully covered by insurance. 10% discount applied for prompt payment.",
  },
  {
    id: 3,
    ...
    items: [
      ...
      {
        description: "Periodontal Examination",
        quantity: 1,
        unitPrice: 120,
        total: 120,
      },
    ...
    notes:
      "Patient paid $500 upfront. Insurance claim pending for $600. Remaining balance due upon insurance approval.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    items: [
      ...
      {
        description: "Post-operative Medication Pack",
        quantity: 1,
        unitPrice: 250,
        total: 250,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        description: "CBCT Scan (3D Imaging)",
        quantity: 1,
        unitPrice: 1200,
        total: 1200,
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        description: "Take-home Whitening Trays",
        quantity: 1,
        unitPrice: 800,
        total: 800,
      },
      {
        description: "Desensitizing Gel",
        quantity: 2,
        unitPrice: 150,
        total: 300,
      },
...
export const chatMessages = [
  {
    ...
    receiverRole: "doctor",
    message:
      "Hello Dr. Smith, I have some questions about my recent root canal treatment.",
  ...
  },
  {
    ...
    message:
      "Hello John! Of course, I'm happy to help. What would you like to know?",
  ...
  },
  {
    ...
    receiverRole: "doctor",
    message:
      "I'm experiencing some sensitivity when drinking cold beverages. Is this normal after the procedure?",
  ...
  },
  {
    ...
    receiverRole: "patient",
    message:
      "Yes, mild sensitivity is completely normal for a few days after a root canal. It should gradually decrease. However, if it persists beyond a week or becomes severe, please let me know immediately.",
  ...
  },
  {
    ...
    receiverRole: "patient",
    message:
      "I recommend scheduling it within the next 2 weeks. I'll have my assistant reach out to you with available appointment slots. In the meantime, try to avoid chewing on that side.",
  ...
  },
  {
    ...
    receiverRole: "doctor",
    message:
      "Hi Dr. Johnson, I'm interested in getting braces. What are my options?",
  ...
  },
  {
    ...
    senderRole: "doctor",
    message:
      "Doctor, I wanted to share my progress photos after the gum treatment.",
...
export const notifications = [
  {
    ...
    message:
      "You have an appointment with Dr. Sunita Agarwalla tomorrow at 10:00 AM",
