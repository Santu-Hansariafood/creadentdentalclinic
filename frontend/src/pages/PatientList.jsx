...
const PatientList = () => {
  ...
  if (loading && !data) return <div className="p-6 text-center">Loading patients...</div>
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <motion.div {...fadeIn('down')} className="mb-6 sm:mb-8">
        ...
        <p className="text-sm sm:text-base text-gray-600">View and manage patient records.</p>
      </motion.div>
        ...
        <>
          ...
          {patients.length === 0 && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center mt-6">
              <p className="text-gray-500">No patients found matching "{debouncedSearch}".</p>
            </div>
          )}
