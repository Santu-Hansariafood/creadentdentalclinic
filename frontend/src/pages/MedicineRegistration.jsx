...
const MedicineRegistration = ({ initialMedicine, onClose }) => {
  ...
  const [registerMedicine, { loading: registerLoading }] = useMutation(REGISTER_MEDICINE, {
    refetchQueries: [
      { query: GET_MEDICINES },
  ...
  const [updateMedicine, { loading: updateLoading }] = useMutation(UPDATE_MEDICINE, {
    refetchQueries: [
      { query: GET_MEDICINES },
      { query: GET_MEDICINE_CATEGORIES },
    ],
      ...
      <div className="flex justify-end gap-3 pt-4">
        ...
        >
          {registerLoading || updateLoading 
            ? (initialMedicine ? "Saving..." : "Registering...") 
            : (initialMedicine ? "Save Changes" : "Register Medicine")}
        </button>
      </div>
    </form>
  );
        ...
        <div className="bg-white rounded-xl shadow-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="font-heading text-xl font-bold text-gray-900">Edit Medicine</h2>
