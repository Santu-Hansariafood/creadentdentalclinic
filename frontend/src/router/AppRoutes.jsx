...
const AppRoutes = ({ isAuthenticated, user }) => {
  const getDashboardRoute = () => (user?.role ? `/${user.role}/dashboard` : "/login");

  return (
    <Suspense fallback={<Preloader />}>
      <Routes>
        {publicContent.pages.map((page) => (
          <Route key={page.slug} path={page.path} element={<PublicContentPage pageSlug={page.slug} />} />
        ))}
        ...
        <Route path="/patient/complete-registration" element={<ProtectedRoute role="patient"><PatientRegistration isSelfRegistration /></ProtectedRoute>} />
        <Route path="/patient/dashboard" element={withPatientCheck(<PatientDashboard />)} />
        <Route path="/patient/appointments" element={withPatientCheck(<Appointments />)} />
        <Route path="/patient/records" element={withPatientCheck(<MedicalRecords />)} />
        <Route path="/patient/prescriptions" element={withPatientCheck(<Prescriptions />)} />
        <Route path="/patient/chat" element={withPatientCheck(<Chat />)} />
        <Route path="/patient/billing" element={withPatientCheck(<Billing />)} />
        <Route path="/patient/settings" element={withPatientCheck(<Settings />)} />
        ...
        <Route path="/admin/staff" element={<ProtectedRoute role="admin"><StaffList /></ProtectedRoute>} />
        ...
        <Route path="/employee/patients" element={<ProtectedRoute role="employee"><PatientList /></ProtectedRoute>} />
        <Route path="/employee/patient-registration" element={<ProtectedRoute role="employee"><PatientRegistration /></ProtectedRoute>} />
        <Route path="/employee/medicines" element={<ProtectedRoute role="employee"><MedicineList /></ProtectedRoute>} />
        <Route path="/employee/medicine-registration" element={<ProtectedRoute role="employee"><MedicineRegistration /></ProtectedRoute>} />
        <Route path="/employee/payment-ledger" element={<ProtectedRoute role="employee"><PaymentLedger /></ProtectedRoute>} />
        <Route path="/employee/appointments" element={<ProtectedRoute role="employee"><Appointments /></ProtectedRoute>} />
        <Route path="/employee/records" element={<ProtectedRoute role="employee"><MedicalRecords /></ProtectedRoute>} />
        <Route path="/employee/billing" element={<ProtectedRoute role="employee"><Billing /></ProtectedRoute>} />
        <Route path="/employee/reports" element={<ProtectedRoute role="employee"><Reports /></ProtectedRoute>} />
        <Route path="/employee/settings" element={<ProtectedRoute role="employee"><Settings /></ProtectedRoute>} />
